...
public class ViewHoaDonChiTiet extends javax.swing.JFrame {
    ...
    private List<HoaDonChiTietCustomModel> listHoaDonCTCustom = new ArrayList<>();
    private List<HoaDon> listHoaDon = new ArrayList<>();
    private List<ChiTietSanPham> listChiTietSP = new ArrayList<>();
    private HoaDonChiTietServiceImpl HoaDonCTService = new HoaDonChiTietServiceImpl();
    ...
    private DefaultComboBoxModel dfcbHoaDon = new DefaultComboBoxModel();
    ...
    public ViewHoaDonChiTiet() {
        ...
        cbbIdHoaDon.setModel(dfcbHoaDon);
        cbbIdChiTietSP.setModel(dfcbChiTietSP);
        String header[] = {"ID Hóa Đơn", "ID Chi Tiết SP", "Số lượng", "Đơn giá"};
        dtm.setColumnIdentifiers(header);
        listHoaDonCTCustom = HoaDonCTService.getAllCustom();
        listHoaDon = HoaDonService.getAll();
        listChiTietSP = ChiTietSPService.getAll();
        listHoaDon.forEach(hoaDon -> cbbIdHoaDon.addItem(hoaDon.getId()));
        listChiTietSP.forEach(ChiTietSP -> cbbIdChiTietSP.addItem(ChiTietSP.getId()));
        loadData(listHoaDonCTCustom);
    }

    private void loadData(List<HoaDonChiTietCustomModel> listHoaDonCTCustom) {
        dtm.setRowCount(0);
        for (HoaDonChiTietCustomModel hdct : listHoaDonCTCustom) {
            dtm.addRow(hdct.todataRow());
        }
    }

    private void fill(int index) {
        HoaDonChiTietCustomModel hdct = listHoaDonCTCustom.get(index);
        cbbIdHoaDon.setSelectedItem(hdct.getIdHd());
        cbbIdChiTietSP.setSelectedItem(hdct.getIdCtsp());
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cbbIdHoaDon, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        String idHD = cbbIdHoaDon.getSelectedItem().toString();
        ...
        HoaDonChiTiet hdct = new HoaDonChiTiet(hoaDon, chiTietSP, Integer.valueOf(soLuong), BigDecimal.valueOf(Double.valueOf(donGia)));
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (row < 0) {
            ...
            HoaDonChiTietCustomModel hdct = listHoaDonCTCustom.get(row);
            String idHd = hdct.getIdHd();
            String idCtsp = hdct.getIdCtsp();
            JOptionPane.showMessageDialog(this, HoaDonCTService.delete(idHd, idCtsp));
            listHoaDonCTCustom = HoaDonCTService.getAllCustom();
            loadData(listHoaDonCTCustom);
        }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (row < 0) {
            ...
            HoaDonChiTietCustomModel hdctCustom = listHoaDonCTCustom.get(row);
            String idHd = hdctCustom.getIdHd();
            String idCtsp = hdctCustom.getIdCtsp();
            HoaDonChiTiet hdct = new HoaDonChiTiet();
            hdct.setSoLuong(Integer.valueOf(txtSoLuong.getText()));
            hdct.setDonGia(BigDecimal.valueOf(Double.valueOf(txtDonGia.getText())));
            String idHD = cbbIdHoaDon.getSelectedItem().toString();
            String idCTSP = cbbIdChiTietSP.getSelectedItem().toString();
            HoaDon hoaDon = HoaDonService.getOne(idHD);
            ...
            JOptionPane.showMessageDialog(this, HoaDonCTService.update(hdct, idHd, idCtsp));
            listHoaDonCTCustom = HoaDonCTService.getAllCustom();
            loadData(listHoaDonCTCustom);
        }
