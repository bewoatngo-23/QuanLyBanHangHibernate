...
public class ViewMauSac extends javax.swing.JFrame {
    ...
    private List<MauSacCustomModel> listMauSacCustom;
    ...
    public ViewMauSac() {
        ...
        listMauSacCustom = new ArrayList<>();
        MauSacService = new MauSacServiceImpl();
        listMauSacCustom = MauSacService.getAllCustom();
        loadData(listMauSacCustom);
    }

    private void loadData(List<MauSacCustomModel> listMauSac) {
        dtm.setRowCount(0);
        for (MauSacCustomModel mauSac : listMauSac) {
            dtm.addRow(mauSac.todataRow());
        }
    }

    private void fill(int index) {
        MauSacCustomModel mauSac = listMauSacCustom.get(index);
        lbID.setText(mauSac.getId());
        txtMa.setText(mauSac.getMa());
        txtTen.setText(mauSac.getTen());
    }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (row < 0) {
            ...
            MauSacCustomModel ms = listMauSacCustom.get(row);
            String ma = ms.getId();
            MauSac mauSac = new MauSac();
            mauSac.setMa(txtMa.getText());
            mauSac.setTen(txtTen.getText());
            JOptionPane.showMessageDialog(this, MauSacService.update(mauSac, ma));
            listMauSacCustom = MauSacService.getAllCustom();
            loadData(listMauSacCustom);
        }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (row < 0) {
            ...
            MauSacCustomModel mauSac = listMauSacCustom.get(row);
